    ...
    return (
        (u.SystemInfo = (function () {
            ...
            (t = s.indexOf('Opera')) != -1
                ? ((a = 'Opera'),
                  (i = s.substring(t + 6)),
                  (t = s.indexOf('Version')) != -1 && (i = s.substring(t + 8)))
                : (t = s.indexOf('MSIE')) != -1
                ? ((a = 'Microsoft Internet Explorer'),
                  (i = s.substring(t + 5)))
                : (t = s.indexOf('Edge')) != -1
                ? ((a = 'Edge'), (i = s.substring(t + 5)))
                : (t = s.indexOf('Chrome')) != -1
                ? ((a = 'Chrome'), (i = s.substring(t + 7)))
                : (t = s.indexOf('Safari')) != -1
                ? ((a = 'Safari'),
                  (i = s.substring(t + 7)),
                  (t = s.indexOf('Version')) != -1 && (i = s.substring(t + 8)))
                : (t = s.indexOf('Firefox')) != -1
                ? ((a = 'Firefox'), (i = s.substring(t + 8)))
                : s.indexOf('Trident/') != -1
                ? ((a = 'Microsoft Internet Explorer'),
                  (i = s.substring(s.indexOf('rv:') + 3)))
                : (e = s.lastIndexOf(' ') + 1) < (t = s.lastIndexOf('/')) &&
                  ((a = s.substring(e, t)),
                  (i = s.substring(t + 1)),
                  a.toLowerCase() == a.toUpperCase() &&
                      (a = navigator.appName)),
                (n = i.indexOf(';')) != -1 && (i = i.substring(0, n)),
                (n = i.indexOf(' ')) != -1 && (i = i.substring(0, n)),
                (n = i.indexOf(')')) != -1 && (i = i.substring(0, n)),
                (d = parseInt('' + i, 10)),
                isNaN(d)
        ...
        (u.XMLHttpRequest = (function () {
                    ...
                    this.xhr.addEventListener(
                        ...
                        function () {
                            ...
                            n.enabled &&
                                !n.revalidated &&
                                (304 == t.status
                                    ? ((n.result.revalidated =
                                          n.result.accessed),
                                      (n.revalidated = !0),
                                      u.execute(i.name, 'put', [n.result]),
                                      e(
                                          "'" +
                                              n.result.url +
            ...
            (s.prototype.send = function (t) {
                ...
                return (
                    (o.enabled =
                        o.enabled && 'arraybuffer' == r.responseType && !t),
                    o.enabled
                        ? void u.execute(
                              i.name,
                              'get',
